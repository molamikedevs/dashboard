        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              value={values.email}
              disabled
              className="peer block w-full rounded-md border bg-custom-muted border-custom-border py-2 pl-10 text-gray-500 cursor-not-allowed"
